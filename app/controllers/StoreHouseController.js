...
export default class StoreHouseController {
  ...
  #preLoadStoreHouseData() {
    ...
    try {
      clothingItem1 = new Clothes(
        111,
        "Blue Hoodie",
        "A blue hoodie",
        30,
        21,
        ["../../public/media/bluehoodie.jpg"],
        "XL",
        "Blue",
        "M"
      );
      clothingItem2 = new Clothes(
        222,
        "Red Skirt",
        "A red skirt",
        27,
        21,
        ["../../public/media/redskirt.jpg"],
        "S",
        "Red",
        "F"
      );
      clothingItem3 = new Clothes(
        333,
        "Black Trousers",
        "A pair of black trousers",
        40,
        21,
        ["../../public/media/blacktrousers.jpg"],
        "M",
        "Black",
        "U"
      );
    ...
    try {
      perfumeItem1 = new Perfume(
        444,
        "CK One",
        "Perfume from calvin klein",
        49.95,
        21,
        ["../../public/media/ckone.jpg"],
        "flowers/citric",
        "F"
      );
      perfumeItem2 = new Perfume(
        555,
        "Eau de Rochas",
        "Perfume from Rochas",
        54.0,
        21,
        ["../../public/media/eaurochas.png"],
        "citric",
        "F"
      );
    ...
    try {
      smartWatchItem1 = new SmartWatch(
        666,
        "Apple Watch",
        "New apple watch model 12",
        800,
        21,
        ["../../public/media/applewatch.jpg"],
        "AW-12",
        "Square",
        "White"
      );
      smartWatchItem2 = new SmartWatch(
        777,
        "Samsung Watch",
        "New samsung watch s8",
        650,
        21,
        ["../../public/media/samsungwatch.jpg"],
        "SMGW-S8",
        "Round",
        "White"
      );
      smartWatchItem3 = new SmartWatch(
        888,
        "Xiaomi Mi band 7",
        "New mi band 7",
        30,
        21,
        ["../../public/media/miband.png"],
        "XMI7",
        "Stretched",
        "Black"
      );
    ...
    try {
      cat1 = new Category(
        "Bottom-Clothing",
        "Clothes that fit under the waist"
      );
    ...
    try {
      store1 = new Store(
        ...
        "C/ Mayor 12",
        967899011,
        new Coords("50.4536", "30.5164 50° 27′ 13″ North, 30° 30′ 59″ East"),
        "mmStore.jpg"
      );
      store2 = new Store(
        "H50463439",
